...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=256, patch_size=4, in_chans=3, num_classes=3,
        ...
        self.num_layers_downsample = len(depths) - 1
        ...
        self.bottleneck_model = ViViT(64, 2, 2, 4, dim=768 * 2, in_channels=768)
    ...
    def temporal_copies(self, x):
        ...
        skip_connection = []
        for i in range(4):
            skip_connection.append(torch.concatenate((temporal_downsample[i],
                                                      temporal_downsample[i + 4],
                                                      temporal_downsample[i + 8],
                                                      temporal_downsample[i + 12]), axis=-1))
